            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              ...
              <div className="p-8 lg:p-12 flex flex-col justify-center">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-gold font-inter font-semibold">VIP Access</span>
                </div>
                
                <h2 className="text-3xl lg:text-4xl font-playfair font-bold mb-4">
                  Stay In <span className="text-gold">Style</span>
                </h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <Button 
                      type="submit" 
                      size="lg"
                      className="bg-gold hover:bg-gold-dark text-primary font-inter font-semibold h-12 px-8 shadow-gold"
              ...
              <div className="relative h-64 lg:h-auto bg-gradient-to-br from-pastel-blush to-pastel-lavender">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center p-8">
                    <div className="w-24 h-24 bg-gold rounded-full flex items-center justify-center mb-4 mx-auto shadow-gold">
                ...
                <div className="absolute bottom-8 left-8 w-8 h-8 bg-gold/30 rounded-full"></div>
