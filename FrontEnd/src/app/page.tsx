export default function Home() {
  return (
    <div>
      <section className="border-b border-black/10 surface-pastel-pink">
        <div className="container py-16 text-center">
          ...
          <div className="mt-8 flex items-center justify-center gap-3">
            <a href="#latest" className="btn btn-gold">Read Latest</a>
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {Array.from({ length: 6 }).map((_, index) => (
            <article key={index} className="card">
              <div className="aspect-[16/10] surface-pastel-blue" />
              <div className="p-4">
                <div className="badge">Fashion</div>
      ...
      <section className="surface-pastel-mint">
        <div className="container py-14">
          <h2 className="section-title">Category Highlights</h2>
          <div className="mt-8 grid grid-cols-1 md:grid-cols-4 gap-6">
            {["Fashion", "Beauty", "Lifestyle", "Celebrity"].map((category) => (
              <a key={category} href={`/blog/${category.toLowerCase()}`} className="card p-6 hover:shadow-sm transition">
      ...
      <section className="container py-14">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <form className="flex gap-3">
            <input type="email" placeholder="Your email address" className="flex-1 border border-black/15 rounded-full px-4 py-3 outline-none focus-ring" />
      ...
      <section className="border-t border-black/10">
        <div className="container py-14">
          ...
          <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-2">
            {Array.from({ length: 6 }).map((_, index) => (
              <div key={index} className="aspect-square surface-pastel-pink" />
            ))}
          </div>
        </div>
      </section>
